...
def main():
    ...
    dep_time = st.sidebar.time_input('Departure Time', datetime.time(0, 0))
    ...
    arr_time = st.sidebar.time_input('Arrival Time', datetime.time(0, 0))
    ...
    rfr_model = cpickle.load(bz2.BZ2File('flight_rf.pbz2','rb'))
